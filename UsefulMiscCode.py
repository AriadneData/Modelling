"""
Useful Code coped from 
https://github.com/shakedzy/dython/blob/master/build/lib/dython/model_utils.py

This has code to:
1) Print ROC curves
2) Output Feature Importance
3) Has a useful function that converts between numpy arrays, lists and pandas
